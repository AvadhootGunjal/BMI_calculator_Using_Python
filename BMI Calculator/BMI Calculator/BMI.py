...
text_label = tk.Label(root, text="Height(cms)",bg="white")
text_label.place(x=90, y=120)
Label(root,image=box).place(x=240,y=100)
text_label = tk.Label(root, text="Weight(kgs)",bg="white")
text_label.place(x=310, y=120)
